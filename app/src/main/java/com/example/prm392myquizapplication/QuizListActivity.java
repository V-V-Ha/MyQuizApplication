...
public class QuizListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (intent != null) {
            subject = intent.getParcelableExtra(Constants.SUBJECT);
            ...
            new AsyncTask<Void, Void, List<Quiz>>() {
                ...
                protected List<Quiz> doInBackground(Void... voids) {
                    ...
                    return UserDatabaseClient.getInstance(QuizListActivity.this).quizDao().getQuizBySubject(subject.getSubjectID());
                }

                @Override
                protected void onPostExecute(List<Quiz> quizzes) {
                    quizList = quizzes;
                    Title = findViewById(R.id.tv_quiz_subject);
                    ...
                    btnNext.setOnClickListener(view -> {
                        ...
                        if(radioButton == null){
                            runOnUiThread(() -> Toast.makeText(QuizListActivity.this, "Select Answer!!", Toast.LENGTH_SHORT).show());
                            return;
                        }
                        ...
                        if (btnNext.getText().equals(getString(R.string.next))){
                            ...
                            Intent intentResult = new Intent(QuizListActivity.this,FinalResultActivity.class);
