...
import com.example.prm392myquizapplication.EditTuVungActivity;
...
public class AdminTuVungAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View view = inflater.inflate(R.layout.row_vocabulary, null);
    ...
    private ArrayList<TuVung> getTuVung(int id) {
        ...
        for (int i = 0; i < cursor.getCount(); i++) {
            ...
            listTV.add(new TuVung(idtu,idbo,dapan,dichnghia,loaitu,anh));
        }
        return listTV;
    }
}
