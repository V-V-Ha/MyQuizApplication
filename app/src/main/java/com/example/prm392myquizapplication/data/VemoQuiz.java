...
public class VemoQuiz implements Serializable {
    private int idcau;
    private int idbo;
    ...
    public VemoQuiz(int idcau, int idbo, String noidung, String dapanA, String dapanB, String dapanC, String dapanD, String dapanTrue) {
        this.idcau = idcau;
        this.idbo = idbo;
