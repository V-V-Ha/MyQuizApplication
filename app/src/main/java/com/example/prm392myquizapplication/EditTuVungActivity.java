...
public class EditTuVungActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imgBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(EditTuVungActivity.this, ManageVocabularyActivity.class);
        ...
        imgEdit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (dapan == "" || nghia == "" || loaitu == "") {
                    Toast.makeText(EditTuVungActivity.this, "Chưa điền đầy thông tin", Toast.LENGTH_SHORT).show();
                }
                else {
                    Boolean result = updateTuVung(tuVung.getIdtu(), tuVung.getIdbo(), dapan, nghia, loaitu, anh);
                    if (result) {
    ...
    private TuVung getTuVungByID(int id) {
        ...
        for (int i = 0; i < cursor.getCount(); i++) {
            ...
            listTuVung.add(new TuVung(idtu, idbo, dapan, nghia, loaitu, anh));
        }
    ...
    private Boolean updateTuVung(int idtu, int idbo, String dapan, String nghia, String loaitu, byte[] anh) {
        database = Database.initDatabase(EditTuVungActivity.this, DATABASE_NAME);
